...
# Schema version — do not edit manually. meeting-hive bumps this when it
# runs a config migration (a backup of the previous file is written as
# config.yaml.bak-v<N> beside this file).
